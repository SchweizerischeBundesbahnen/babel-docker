...
<form id='translation-form'>
	...
	<?php if($line['non_translatable'] == 0) {?>
		...
		<textarea id="current-translation" style='display: inline; width: 95%; height: 154px;' name="translation"><?=((stripslashes($line['translation_value'])));?></textarea>
		<br />
		...
		<?php
			...
			if(!mysql_num_rows($res_history)){
				...
				while($line = mysql_fetch_array($res_history, MYSQL_ASSOC)){
					...
					print "<div>".str_replace(' ','&nbsp',stripslashes(nl2br(htmlspecialchars($line['value']))))."</div>";
					print "</td>";
					print "<td width='20%'>";
