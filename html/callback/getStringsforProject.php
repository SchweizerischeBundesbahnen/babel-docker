...
while($line = mysql_fetch_array($res, MYSQL_ASSOC)){
    if(isset($stringids[$line['stringId']])){
      ...
      # Roger: code fix for missing texts
      $string_value = nl2br(htmlspecialchars($line['text']));
      $string_value = preg_replace("/\\\\u(([a-fA-F0-9]{1,4}))/", "&#x\\1;", $string_value);
      $line['text'] = $string_value;  
    	...
    	$line['translationString'] = stripslashes(str_replace(' ','&nbsp;',str_replace("\\\\","\\",nl2br(htmlspecialchars($line['translationString'])))));
